...
Public Class formPenjualan
    ...
    Protected Sub tampilJual(ByVal xGrid As DataGridView)
        With xGrid
            .ColumnCount = 10
        ...
        Try
            ...
            If rd.HasRows Then
                While rd.Read
                    ...
                    baris(1) = rd(1) 'Tanggal Penjualan
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            Dim cmd As New SqlCommand("tambahJual", koneksi)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Dim cmd As New SqlCommand("ubahJual", koneksi)
        Dim xParam As New SqlParameter
        xParam.Direction = ParameterDirection.Input
        Try
            koneksi.Open()
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If MessageBox.Show("Yakin Akan Dihapus?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Dim cmd As New SqlCommand("hapusJual", koneksi)
            Dim xParam As New SqlParameter
            xParam.Direction = ParameterDirection.Input
            Try
                koneksi.Open()
        ...
        Try
            ...
            If rd.HasRows Then
                While rd.Read
                    ...
                    TextBox4.Text = rd.Item("hargaJual")
                End While
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)

...
Public Class formPemasok
    ...
    Protected Sub tampilPemasok(ByVal xGrid As DataGridView)
        With xGrid
            .ColumnCount = 4
        ...
        Try
            ...
            If rd.HasRows Then
                While rd.Read
                    ...
                    baris(0) = rd(0) 'ID Pemasok
                    baris(1) = rd(1) 'Nama Pemasok
                    baris(2) = rd(2) 'Alamat
    ...
    Private Sub formPemasok_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call tampilPemasok(DataGridView1)
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Else
            Dim cmd As New SqlCommand("tambahPemasok", koneksi)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Dim cmd As New SqlCommand("ubahPemasok", koneksi)
        Dim xParam As New SqlParameter
        xParam.Direction = ParameterDirection.Input
        Try
            koneksi.Open()
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If MessageBox.Show("Yakin Akan Dihapus?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Dim cmd As New SqlCommand("hapusPemasok", koneksi)
            Dim xParam As New SqlParameter
            xParam.Direction = ParameterDirection.Input
            Try
                koneksi.Open()
